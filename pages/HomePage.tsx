    ...
    <>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#F9F8F4]/95 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-bold tracking-[0.15em] text-stone-500">
            ...
            <Link to="/stories" className="hover:text-nobel-gold transition-colors cursor-pointer uppercase flex items-center gap-1">
              <BookOpen size={12} />
              {lang === 'sv' ? 'Journal' : 'Journal'}
            </Link>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-40 bg-[#F9F8F4] flex flex-col items-center justify-center gap-8 text-xl font-serif animate-fade-in">
            ...
            <Link to="/stories" onClick={() => setMenuOpen(false)} className="hover:text-nobel-gold transition-colors cursor-pointer flex items-center gap-2">
              <BookOpen size={18} />
              {lang === 'sv' ? 'AI Journal' : 'AI Journal'}
            </Link>
